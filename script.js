     ...
     function snipePrefilledPlayer() {
        ...
        try {
          setTimeout(function(){
            ...
            if (document.getElementsByClassName('btn-standard buyButton currency-coins')[0] != undefined){
              try {
                ...
                // Click OK button
                // setTimeout(function(){
                //   var okButton = document.getElementsByClassName('ut-navigation-button-control' )[0];
                //   touchElement(okButton);
                // }, 585);
